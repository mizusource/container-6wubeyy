...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6wubeyy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6wubeyy.containers.anotherwebservice.com/
...
```
git clone git@github.com:mizusource/container-6wubeyy.git
cd container-6wubeyy
```
...
```
docker attach container-6wubeyy
```
